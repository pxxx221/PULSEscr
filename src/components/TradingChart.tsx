...
import { MoveHorizontal, Trash2, LineChart, Ruler, Landmark, Magnet, Copy, Check, Activity, Share2, GitBranch } from "lucide-react";
  ...
  return (
    <div className="pulse-chart">
      ...
      <div className="pulse-symbol-header">
        ...
        <div className="pulse-current-price">{currentPrice !== null ? '$'+formatChartPrice(currentPrice) : '—'}<small>LAST PRICE</small></div>
